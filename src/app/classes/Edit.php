...
class Edit extends Dbh{
    ...
    public function Edit(){
        try{
            ...
            header("Location: ../list.php?succes=1");
        } catch (Exception $e){
            echo $e->getMessage();
            header("Location: ../edit_form.php?succes=0");
        }
    }
    ...
    private function UpdateValuesInDatabase(){
        try{
            $pdo = $this->connect();
            ...
            $sql = "UPDATE rekrutacja_uczen_tbl SET " . implode('=?, ', $columns) . "=? WHERE id=?";
