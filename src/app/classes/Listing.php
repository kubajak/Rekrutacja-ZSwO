...
class Listing extends Dbh{
    ...
    private function GetStudents(){
        try{
            $pdo = $this->connect();
            $sql = "SELECT id,pesel,imie,nazwisko,wybor1,wybor2,wybor3 FROM rekrutacja_uczen_tbl";
            ...
            if($count > 0){
                ...
                foreach($row as $row){
                    ...
                    echo "<td class='td_uczen'><a href=\"classes/Remove.php?id={$row['id']}\"><img src='../../img/icon/user-minus-solid.svg' style='width:16px;'></td>";
                    echo "<td class='td_uczen'><a href=\"edit_form.php?id={$row['id']}\"><img src='../../img/icon/user-edit-solid.svg' style='width:16px;'></td>";
                    echo "</tr>";
                }
                echo "</table>";
                echo '</div>';
