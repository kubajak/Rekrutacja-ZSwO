        ...
        try{
            ...
            if($count > 0){
                ...
                foreach($row as $row){
                    ...
                    echo "<td class='td_uczen'><a href=\"#\" onclick=\"confirmDelete('classes/FormHandler.class.php?id={$row['id']}', '{$row['id']}')\"><img src='../../img/icon/user-minus-solid.svg' style='width:16px;'></td>";
