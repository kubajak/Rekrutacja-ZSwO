...
<head>
    ...
    <link rel="stylesheet" href="../../classes/bootstrap/css/bootstrap.css">
                ...
                <form action="dodaj_ucznia.php" method="post" autocomplete="off">
                    <div class="row">
                        <div class="col-50" id="col-50-id"><br />
                            ...
                            <input type="text" name="pesel" id="pesel_spr" placeholder="12345678910" required>
                            <label for="email">Imię:</label>
                            <input type="text" name="imie" id="imie_spr" required>
                            <label for="adr">Drugie Imię:</label>
                            <input type="text" name="drugie_imie" id="drugie_imie_spr">
                            <label for="city">Nazwisko:</label>
                            <input type="text" name="nazwisko" id="nazwisko_spr" required>
                            <label for="state">Miejscowość:</label>
                            <input type="text" name="miejscowosc" id="miejscowosc_spr" required>
                            <label for="zip">Kod Pocztowy:</label>
                            <input type="text" name="kod_pocztowy" id="kod_pocztowy_spr" placeholder="12-345" required>
                            <label for="state">Ulica i numer domu:</label>
                            <input type="text" name="ulica_numer" id="ulica_spr">
                            <label for=" state">Szkoła podstawowa:</label>
                            <input type="text" name="szkola_podstawowa" id="szkola_spr" required>
                            <label for=" state">Język wiodący:</label>
                            <div class="row">
                                <div class="col-50">
                                    <label><input type="radio" id="state" name="jezyk_obcy_text" value="ang" checked>Język Angielski</label>
                                </div>
                                <div class="col-50">
