...
<head>
    ...
    <title>Profil Sportowo Turystyczny, Sportowy</title>
    ...
    <div class="container">
        <div class="row">
            <div class="col text-center">
                <h2>Profil Sportowo Turystyczny, Sportowy</h2>
            </div>
        </div>
    </div>
    <?php
    include("profile_fun.php");
    echo profile_fun_wypis("profil_sportowo_turystyczny_sportowy", "Profil Sport-Tur, Sport");
    ?>
</body>
