                ...
                <form action="edytuj_uczen.php" method="POST" autocomplete="off">
                    <div class="row">
                        <div class="col-50" id="col-50-id"><br />
                            ...
                            <input type="text" name="id_uczen_edycja" value="ID: " readonly required disabled>
                            <label for="fname">PESEL:</label>
                            <input type="text" name="pesel_text" id="pesel_spr" value="" readonly required>
                            <label for="email">Imię:</label>
                            <input type="text" name="imie_text" id="imie_spr" value="" required>
                            <label for="adr">Drugie Imię:</label>
                            <input type="text" name="drugie_imie_text" id="drugie_imie_spr" value="">
                            <label for="city">Nazwisko:</label>
                            <input type="text" name="nazwisko_text" id="nazwisko_spr" value="" required>
                            <label for="state">Miejscowość:</label>
                            <input type="text" name="miejscowosc_text" id="miejscowosc_spr" value="" required>
                            <label for="zip">Kod Pocztowy:</label>
                            <input type="text" name="kod_pocztowy_text" id="kod_pocztowy_spr" value="" required>
                            <label for="state">Ulica i numer domu:</label>
                            <input type="text" name="ulica_numer_text" id="ulica_spr" value="">
                            <label for=" state">Szkoła podstawowa:</label>
                            <input type="text" name="szkola_podstawowa_text" id="szkola_spr" value="" required>
                            <label for=" state">Język wiodący:</label>
                            <div class="row">
                                <div class="col-50">
                                    <label><input type="radio" id="state" name="jezyk_obcy_text" value="ang">Język Angielski</label>
                                </div>
                                <div class="col-50">
